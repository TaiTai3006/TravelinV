...
const tabs = [
  {
    name: "Post",
    style: (
      <BsFillFilterSquareFill className="Thang_a"></BsFillFilterSquareFill>
    ),
  },
  {
    name: "PostLike",
    style: <BsBookmarkHeartFill className="Thang_"></BsBookmarkHeartFill>,
  },
  {
    name: "Bag",
    style: <BsFillHandbagFill className="Thang_a"></BsFillHandbagFill>,
  },
];

const Event_bv = {
  id: "Post" /*,content: <ul id='edit_remove'><li><button className='Thang_event'><span><MdEdit id='mdedit'></MdEdit></span> Edit</button></li><li><button className='Thang_event'><span><MdOutlineBookmarkRemove id='mdremove'></MdOutlineBookmarkRemove></span> Remove</button></li></ul>*/,
};
const Event_like = {
  id: "PostLike" /*, content: <ul id='edit_remove'><li><button className='Thang_event'><span><RiDislikeLine id='mdremove'></RiDislikeLine></span> Unlike</button></li></ul>*/,
};
const Event_td = {
  id: "Bag" /*, content: <ul id='edit_remove'><li><button className='Thang_event'><span><MdOutlineBookmarkRemove id='mdremove'></MdOutlineBookmarkRemove></span> Remove</button></li></ul>*/,
};

const Bag = [
  {
    Image:
      "https://scontent-tpe1-1.xx.fbcdn.net/v/t39.30808-6/316241281_2167460543438400_1162359507881539794_n.jpg?_nc_cat=105&ccb=1-7&_nc_sid=5cd70e&_nc_ohc=gmlGm8qGSQkAX9ezcEg&tn=LBhcdzXBroSyhQQ6&_nc_ht=scontent-tpe1-1.xx&oh=00_AfBpMod-KAnhRo_craBySBywdAU-tH-NricAQ4IlqPUkMQ&oe=637F737B",
    Title: "Đà Nẵng",
  ...
  {
    Image:
      "https://khongsolac.com/wp-content/uploads/2019/09/flc-quy-nhon-5.jpg",
    Title: "Bình Định",
...
const PostsLike = [
  ...
  },
  {
    ...
    Time: "20/11/2022",
    Image:
      "https://statics.vinpearl.com/du-lich-pho-co-hoi-an-5654_1628254007.jpg",
    Author: "Phú Sỹ",
    id: "2",
  },
  {
      ...
      return (
        <ul className="Thang_edit_remove">
          ...
          <li
            id="Thang_li2"
            onClick={() => {
              const NewPosts = Content.filter((post) => post.id !== id);
              setContent(NewPosts);
              setCountPost(NewPosts.length);
            }}
          >
            <span className="Thang_span">
      ...
      return (
        <ul className="Thang_edit_remove">
          <li
            className="Thang_li"
            onClick={() => {
              const NewPostLike = Content.filter(
                (postlike) => postlike.id !== id
              );
              setContent(NewPostLike);
              setCountPostLike(NewPostLike.length);
            }}
          >
            <span className="Thang_span">
      ...
      return (
        <ul className="Thang_edit_remove">
          <li
            className="Thang_li"
            onClick={() => {
              const NewBag = Content.filter((bag) => bag.id !== id);
              setContent(NewBag);
              setCountBag(NewBag.length);
            }}
          >
            <span className="Thang_span">
              <MdOutlineBookmarkRemove id="mdremove"></MdOutlineBookmarkRemove>
    ...
    <div className="Thang_avatar">
      ...
      <div id="Thang_content0">
        ...
        <div id="Thang_tab">
          ...
          <p className="Thang_tab_content">
            <span>{CountBag}</span> {tabs[2].name}
          </p>
        </div>
      </div>
      <div>
        ...
        {Content.map((Content0) => (
          <div key={Content0.id}>
            ...
            <p id="Thang_CONTENT">
              ...
              {HandlCoutContent(type, Content0.Location, Content0.Time)}{" "}
            </p>
          </div>
        ))}
      </div>
