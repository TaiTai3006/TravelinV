...
const article = [
  {
    ...
    image: "https://dulichkhatvongviet.com/wp-content/uploads/2022/03/an-giang.jpg"
  },
...
function App() {
  ...
  return (
    ...
    <input type="text" 
    onChange={(text) => {
      setSearch(article.filter((article)=>{
      return article.title.toLowerCase().includes(text.target.value.toLowerCase()) 
    }
    ))}} 
    placeholder={"Type to search within" + " " + Province.province_name + "..." } />
