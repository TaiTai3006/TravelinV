...
function App() {
  ...
  return (
    <div className="admin-page">
      ...
      return post.title.toLowerCase().includes(text.target.value.toLowerCase()) ||  post.usename.toLowerCase().includes(text.target.value.toLowerCase())
    }
    ))
    setSearchUser(user.filter((user)=>{
      return user.usename.toLowerCase().includes(text.target.value.toLowerCase())
    }
    ))
